...
export const translations: TranslationDictionary = {
  // Navigation
  nav_home: { en: 'Home', ar: 'الرئيسية', ku: 'سەرەتا' },
  nav_services: { en: 'Services', ar: 'خدماتنا', ku: 'خزمەتگوزارییەکان' },
  nav_portfolio: { en: 'Portfolio', ar: 'أعمالنا', ku: 'نموونەی کارەکان' },
  nav_about: { en: 'About', ar: 'من نحن', ku: 'دەربارەی ئێمە' },
  nav_contact: { en: 'Contact', ar: 'اتصل بنا', ku: 'پەیوەندی' },
  
  // Hero
  hero_title: { 
    en: 'Your Vision, Printed to Perfection', 
    ar: 'رؤيتك، مطبوعة بإتقان', 
    ku: 'خەیاڵەکانت بە باشترین شێوە چاپ دەکەین' 
  },
  hero_subtitle: { 
    en: 'Premium DTF and UV printing serving all of Kurdistan & Iraq. Fast delivery to every city.', 
    ar: 'طباعة DTF و UV فاخرة تخدم جميع أنحاء كوردستان والعراق. توصيل سريع لجميع المدن.', 
    ku: 'چاپی نایابی DTF و UV بۆ تەواوی کوردستان و عێراق. گەیاندنی خێرا بۆ هەموو شارەکان.' 
  },
